...
int main(int argc, char *argv[]) {
  ...
  anim.SetConstantPosition(serverNode.Get(0), 200, 200);
  anim.SetConstantPosition(clientNodes.Get(0), 200, 250);
  anim.SetConstantPosition(clientNodes.Get(1), 200, 150);
  anim.SetConstantPosition(clientNodes.Get(2), 150, 200);
  anim.SetConstantPosition(clientNodes.Get(3), 250, 200);
  Simulator::Run();
  Simulator::Destroy();
  NS_LOG_INFO("Done.");
